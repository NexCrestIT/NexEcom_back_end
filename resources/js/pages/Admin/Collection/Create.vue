...
const breadcrumbItems = computed(() => [
    ...
    },
    {
        ...
        href: CollectionController.create.url(),
    },
]);

function save() {
    form.post(CollectionController.store.url(), {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
            form.reset();
...
function cancel() {
    form.get(CollectionController.index.url());
}
</script>
...
<template>
    ...
    <AppSidebarLayout title="Create Collection" :breadcrumbs="breadcrumbItems">
            ...
            <div class="rounded-lg border border-border bg-card p-6">
                <form @submit.prevent="save" class="flex flex-col gap-6">
                    ...
                    <div class="flex justify-end gap-2 mt-4 pt-4 border-t">
                        ...
                        <Button type="submit" label="Create Collection" icon="pi pi-check" :loading="form.processing"
