...
function save() {
    updateFormValues();
    form.post(OptionController.store.url(), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset();
            valueList.value = [];
...
function cancel() {
    form.get(OptionController.index.url());
}
</script>
...
<template>
    ...
    <AppSidebarLayout title="Create Option" :breadcrumbs="breadcrumbItems">
            ...
            <div class="rounded-lg border border-border bg-card p-6">
                <form @submit.prevent="save" class="flex flex-col gap-6">
                    ...
                    <div class="flex justify-end gap-2 mt-4 pt-4 border-t">
                        ...
                        <Button type="submit" label="Create Option" icon="pi pi-check" :loading="form.processing"
