...
function cancel() {
    form.get(BrandController.index.url());
}
</script>
...
<template>
    ...
    <AppSidebarLayout title="Create Brand" :breadcrumbs="breadcrumbItems">
            ...
            <div class="rounded-lg border border-border bg-card p-6">
                <form @submit.prevent="save" class="flex flex-col gap-6">
                    ...
                    <div class="flex justify-end gap-2 mt-4 pt-4 border-t">
                        ...
                        <Button type="submit" label="Create Brand" icon="pi pi-check" :loading="form.processing"
