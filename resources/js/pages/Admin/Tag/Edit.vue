...
const breadcrumbItems = computed(() => [
    ...
    {
        title: `Edit: ${props.tag.name}`,
        href: TagController.edit.url(props.tag.id),
    },
]);

function save() {
    form.put(TagController.update.url(props.tag.id), {
        preserveScroll: true,
    });
}
...
<template>
    ...
    <AppSidebarLayout :title="`Edit: ${tag.name}`" :breadcrumbs="breadcrumbItems">
