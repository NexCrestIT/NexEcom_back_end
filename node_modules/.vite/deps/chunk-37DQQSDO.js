...
var xhr_default = isXHRAdapterSupported && function(config2) {
  return new Promise(function dispatchXhrRequest(resolve, reject2) {
    ...
    request.onabort = function handleAbort() {
      ...
      reject2(new AxiosError_default("Request aborted", AxiosError_default.ECONNABORTED, config2, request));
      request = null;
    };
    ...
    if (_config.cancelToken || _config.signal) {
      onCanceled = (cancel) => {
        ...
        reject2(!cancel || cancel.type ? new CanceledError_default(null, config2, request) : cancel);
        request.abort();
        request = null;
      };
    ...
    if (protocol && platform_default.protocols.indexOf(protocol) === -1) {
      reject2(new AxiosError_default("Unsupported protocol " + protocol + ":", AxiosError_default.ERR_BAD_REQUEST, config2));
      return;
    }
...
function dispatchRequest(config2) {
  ...
  const adapter2 = adapters_default.getAdapter(config2.adapter || defaults_default2.adapter, config2);
...
@inertiajs/core/dist/index.esm.js:
   ...
   * @license MIT *)
*/
//# sourceMappingURL=chunk-37DQQSDO.js.map
